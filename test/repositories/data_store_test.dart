...
void main() {
  group('DataStoreRepository', () {
    ...
    test('load Success', () async {
      ...
      expect(dataStoreRepository.branchVariables.length, equals(1));
    ...
    test('save Success', () async {
      ...
      dataStoreRepository.branchVariables.add(const BranchVariable(uuid: 'uuid', name: 'name', defaultValue: 'defaultValue'));
