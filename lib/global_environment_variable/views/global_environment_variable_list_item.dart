...
class GlobalEnvironmentVariableListItem extends StatefulWidget {
  const GlobalEnvironmentVariableListItem({Key? key, required this.variable}) : super(key: key);

  final GlobalEnvironmentVariable variable;

  @override
  GlobalEnvironmentVariableListItemState createState() => GlobalEnvironmentVariableListItemState();
}

class GlobalEnvironmentVariableListItemState extends State<GlobalEnvironmentVariableListItem> {
  late GlobalEnvironmentVariable currentValue;
                ...
                onPressed: () {
                  showInputDialog(
                    ...
                    onConfirmButton: (newValue) {
                      ...
                      context.read<GlobalEnvironmentVariablesCubit>().updateValue(currentValue);
                    },
                  );
                },
